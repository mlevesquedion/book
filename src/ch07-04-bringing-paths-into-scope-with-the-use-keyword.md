...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-11/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-12/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-13/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-14/src/main.rs}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-15/src/lib.rs:1:4}}
    // --snip--
#    Ok(())
{{#include ../examples/ch07-managing-growing-projects/listing-07-15/src/lib.rs:6:8}}
    // --snip--
#    Ok(())
{{#include ../examples/ch07-managing-growing-projects/listing-07-15/src/lib.rs:10}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-16/src/lib.rs:1:4}}
    // --snip--
#    Ok(())
{{#include ../examples/ch07-managing-growing-projects/listing-07-16/src/lib.rs:6:8}}
    // --snip--
#    Ok(())
{{#include ../examples/ch07-managing-growing-projects/listing-07-16/src/lib.rs:10}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-17/src/lib.rs}}
# fn main() {}
```
...
```toml
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-02/Cargo.toml:7:}}
```
...
```rust,ignore
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:2:4}}
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:7}}
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-03/src/main.rs:19}}
```
...
```rust
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-04/src/main.rs:1:2}}
// ---snip---
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-18/src/main.rs:1}}
// ---snip---
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-19/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-20/src/lib.rs}}
```
