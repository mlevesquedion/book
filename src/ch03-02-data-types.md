...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-06-floating-point/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-07-numeric-operations/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-08-boolean/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-09-char/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-10-tuples/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-11-destructuring-tuples/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-12-tuple-indexing/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-13-arrays/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-14-array-indexing/src/main.rs}}
```
...
```rust,ignore,panics
{{#include ../examples/ch03-common-programming-concepts/no-listing-15-invalid-array-access/src/main.rs}}
```
