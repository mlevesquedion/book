...
```rust
{{#include ../examples/ch16-fearless-concurrency/listing-16-01/src/main.rs}}
```
...
```rust
{{#include ../examples/ch16-fearless-concurrency/listing-16-02/src/main.rs}}
```
...
```rust
{{#include ../examples/ch16-fearless-concurrency/no-listing-01-join-too-early/src/main.rs}}
```
...
{{#include ../examples/ch16-fearless-concurrency/listing-16-03/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch16-fearless-concurrency/listing-16-04/src/main.rs}}
```
...
```rust
{{#include ../examples/ch16-fearless-concurrency/listing-16-05/src/main.rs}}
```
