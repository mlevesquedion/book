...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-01/src/main.rs}}
```
...
{{#include ../examples/ch15-smart-pointers/listing-15-02/src/main.rs:1:4}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch15-smart-pointers/listing-15-03/src/main.rs:6:10}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-05/src/main.rs}}
```
