...
```text
{{#include ../examples/ch12-an-io-project/listing-12-03/poem.txt}}
```
...
```rust,should_panic
{{#include ../examples/ch12-an-io-project/listing-12-04/src/main.rs:1:4}}
    // --snip--
{{#include ../examples/ch12-an-io-project/listing-12-04/src/main.rs:11:17}}
```
