...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-25/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-26/src/main.rs:20:42}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-27/src/main.rs:1:8}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-27/src/main.rs:10:20}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-28/src/main.rs:1:9}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-28/src/main.rs:11:29}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-29/src/main.rs:11:52}}
```
