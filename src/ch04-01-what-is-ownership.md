...
```rust
{{#include ../examples/ch04-understanding-ownership/listing-04-01/src/main.rs:2:6}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/no-listing-01-can-mutate-string/src/main.rs:2:6}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/no-listing-02-string-scope/src/main.rs:2:7}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/listing-04-02/src/main.rs:2:3}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/no-listing-03-string-move/src/main.rs:2:3}}
```
...
{{#include ../examples/ch04-understanding-ownership/no-listing-04-cant-use-after-move/src/main.rs:2:5}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/no-listing-05-clone/src/main.rs:2:5}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/no-listing-06-copy/src/main.rs:2:5}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/listing-04-03/src/main.rs}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/listing-04-04/src/main.rs}}
```
...
```rust
{{#include ../examples/ch04-understanding-ownership/listing-04-05/src/main.rs}}
```
