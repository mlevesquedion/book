...
```rust,ignore
{{#include ../examples/ch07-managing-growing-projects/listing-07-21-and-22/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-21-and-22/src/front_of_house.rs}}
```
...
```
{{#include ../examples/ch07-managing-growing-projects/no-listing-01-extracting-hosting/src/front_of_house.rs}}
```
...
```
{{#include ../examples/ch07-managing-growing-projects/no-listing-01-extracting-hosting/src/front_of_house/hosting.rs}}
```
