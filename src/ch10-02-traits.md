...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-12/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-13/src/lib.rs:5:}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-01-calling-trait-method/src/main.rs:4:11}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-14/src/lib.rs:1:5}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-02-calling-default-impl/src/main.rs:4:12}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-03-default-impl-calls-other-methods/src/lib.rs:1:7}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-03-default-impl-calls-other-methods/src/lib.rs:16:20}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-03-default-impl-calls-other-methods/src/main.rs:4:11}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-04-traits-as-parameters/src/lib.rs:31:33}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-05-returning-impl-trait/src/lib.rs:31:38}}
```
...
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-06-impl-trait-returns-one-type/src/lib.rs:31:48}}
```
...
```rust,ignore
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/no-listing-07-fixing-listing-10-05/src/main.rs:1}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-15/src/main.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-16/src/lib.rs}}
```
