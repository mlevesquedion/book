...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-14/src/main.rs}}
```
...
{{#include ../examples/ch15-smart-pointers/listing-15-15/src/main.rs:11:16}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-16/src/main.rs:11:16}}
```
