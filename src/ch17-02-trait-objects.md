...
```rust
{{#include ../examples/ch17-oop/listing-17-03/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-04/src/lib.rs:5:7}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-05/src/lib.rs:9:15}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-06/src/lib.rs:5:16}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-07/src/lib.rs:17:27}}
```
...
```rust,ignore
{{#include ../examples/ch17-oop/listing-17-08/src/main.rs:1:13}}
```
...
```rust,ignore
{{#include ../examples/ch17-oop/listing-17-09/src/main.rs:15:38}}
```
...
{{#include ../examples/ch17-oop/listing-17-10/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch17-oop/no-listing-01-trait-object-of-clone/src/lib.rs}}
```
