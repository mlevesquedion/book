...
{{#include ../examples/ch15-smart-pointers/no-listing-01-cant-borrow-immutable-as-mutable/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-20/src/lib.rs}}
```
...
{{#include ../examples/ch15-smart-pointers/listing-15-21/src/lib.rs:36:65}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-22/src/lib.rs:36:58}}
        // --snip--

{{#include ../examples/ch15-smart-pointers/listing-15-22/src/lib.rs:64:66}}
```
...
```rust,ignore,panics
{{#include ../examples/ch15-smart-pointers/listing-15-23/src/lib.rs:51:59}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-24/src/main.rs}}
```
