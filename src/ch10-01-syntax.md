...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-04/src/main.rs:1:29}}
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-04/src/main.rs:31:35}}
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-04/src/main.rs:37}}
```
...
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-05/src/main.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-06/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-07/src/main.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-08/src/main.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-09/src/main.rs}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-10/src/main.rs:12:16}}
```
...
```rust
{{#include ../examples/ch10-generic-types-traits-and-lifetimes/listing-10-11/src/main.rs}}
```
