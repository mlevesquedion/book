...
```rust
{{#include ../examples/ch09-error-handling/listing-09-03/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch09-error-handling/no-listing-02-ask-compiler-for-type/src/main.rs:4}}
```
...
```rust,should_panic
{{#include ../examples/ch09-error-handling/listing-09-04/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch09-error-handling/listing-09-05/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch09-error-handling/no-listing-03-closures/src/main.rs}}
```
...
```rust,should_panic
{{#include ../examples/ch09-error-handling/no-listing-04-unwrap/src/main.rs}}
```
...
```rust,should_panic
{{#include ../examples/ch09-error-handling/no-listing-05-expect/src/main.rs}}
```
...
```rust
{{#include ../examples/ch09-error-handling/listing-09-06/src/main.rs:1:19}}
```
...
```rust
{{#include ../examples/ch09-error-handling/listing-09-07/src/main.rs:1:10}}
```
...
```rust
{{#include ../examples/ch09-error-handling/listing-09-08/src/main.rs:1:11}}
```
...
```rust
{{#include ../examples/ch09-error-handling/listing-09-09/src/main.rs:1:6}}
```
...
```rust,ignore
{{#include ../examples/ch09-error-handling/no-listing-06-question-mark-in-main/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch09-error-handling/no-listing-07-main-returning-result/src/main.rs}}
```
