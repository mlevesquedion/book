...
```rust,ignore
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-01/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-03/src/main.rs}}
```
...
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-04/src/main.rs::5}}

    // --snip--

{{#include ../examples/ch02-guessing-game-tutorial/listing-02-04/src/main.rs:19:}}
```
...
{{#include ../examples/ch02-guessing-game-tutorial/no-listing-01-convert-string-to-number/src/main.rs:14:}}
```
...
{{#include ../examples/ch02-guessing-game-tutorial/no-listing-02-looping/src/main.rs:10:13}}

        // --snip--

{{#include ../examples/ch02-guessing-game-tutorial/no-listing-02-looping/src/main.rs:25:}}
```
...
{{#include ../examples/ch02-guessing-game-tutorial/no-listing-03-quitting/src/main.rs:25:}}
```
...
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-05/src/main.rs:17:25}}
...
```rust,ignore
{{#include ../examples/ch02-guessing-game-tutorial/listing-02-06/src/main.rs}}
```
