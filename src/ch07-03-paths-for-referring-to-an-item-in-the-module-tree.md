...
{{#include ../examples/ch07-managing-growing-projects/listing-07-03/src/lib.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch07-managing-growing-projects/listing-07-05/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-07/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-08/src/lib.rs}}
# fn main() {}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-09/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch07-managing-growing-projects/listing-07-10/src/lib.rs}}
```
