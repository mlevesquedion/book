...
{{#include ../examples/ch15-smart-pointers/listing-15-17/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-18/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-19/src/main.rs:9:19}}
```
