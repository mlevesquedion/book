...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-08/src/main.rs}}
```
...
```rust,ignore
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-08/src/main.rs:11}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-09/src/main.rs}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-10/src/main.rs}}
```
...
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-11/src/main.rs}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-12/src/main.rs}}
```
