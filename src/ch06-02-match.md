...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-03/src/main.rs:1:15}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-08-match-arm-multiple-lines/src/main.rs:8:18}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-04/src/main.rs:1:13}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-09-variable-in-pattern/src/main.rs:15:25}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-05/src/main.rs:2:11}}
```
...
```rust,ignore
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-05/src/main.rs:4}}
```
...
```rust,ignore
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-05/src/main.rs:5}}
```
...
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-10-non-exhaustive-match/src/main.rs:2:6}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-11-underscore-placeholder/src/main.rs:2:9}}
```
