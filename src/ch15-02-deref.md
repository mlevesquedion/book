...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-06/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-07/src/main.rs}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-08/src/main.rs:1:7}}
```
...
{{#include ../examples/ch15-smart-pointers/listing-15-09/src/main.rs:9:15}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-10/src/main.rs:1:9}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-11/src/main.rs:1:3}}
```
...
```rust
{{#include ../examples/ch15-smart-pointers/listing-15-12/src/main.rs:23:26}}
```
