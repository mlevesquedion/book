...
```rust
{{#include ../examples/ch16-fearless-concurrency/listing-16-12/src/main.rs}}
```
...
{{#include ../examples/ch16-fearless-concurrency/listing-16-13/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch16-fearless-concurrency/no-listing-02-no-loop-to-understand-error/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch16-fearless-concurrency/listing-16-14/src/main.rs}}
```
...
```rust
{{#include ../examples/ch16-fearless-concurrency/listing-16-15/src/main.rs}}
```
