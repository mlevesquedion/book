...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-13/src/main.rs}}
```
...
>
> ```rust
> {{#include ../examples/ch05-using-structs-to-structure-related-data/no-listing-03-wheres-the-arrow-operator/src/main.rs:19:20}}
> ```
>
...
```rust,ignore
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-14/src/main.rs}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-15/src/main.rs:7:15}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/no-listing-04-associated-functions/src/main.rs:7:11}}
```
...
```rust
{{#include ../examples/ch05-using-structs-to-structure-related-data/listing-05-15/src/main.rs:7:17}}
```
