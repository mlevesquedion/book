...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-16-functions/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-17-functions-with-parameters/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-18-functions-with-multiple-parameters/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/listing-03-01/src/main.rs}}
```
...
{{#include ../examples/ch03-common-programming-concepts/no-listing-19-statements-vs-expressions/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-20-blocks-are-expressions/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-21-function-return-values/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-22-function-parameter-and-return/src/main.rs}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch03-common-programming-concepts/no-listing-23-statements-dont-return-values/src/main.rs}}
```
