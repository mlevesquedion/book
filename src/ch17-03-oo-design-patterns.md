...
```rust,ignore
{{#include ../examples/ch17-oop/listing-17-11/src/main.rs}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-12/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-13/src/lib.rs:6}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-13/src/lib.rs:14:17}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-14/src/lib.rs:6}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-14/src/lib.rs:18:21}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-15/src/lib.rs:6}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-15/src/lib.rs:22:47}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-16/src/lib.rs:6}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-16/src/lib.rs:28:42}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-16/src/lib.rs:47:54}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-16/src/lib.rs:59:74}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-17/src/lib.rs:6}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-17/src/lib.rs:18:20}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-17/src/lib.rs:33}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-18/src/lib.rs:35}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-18/src/lib.rs:39:42}}

// --snip--
{{#include ../examples/ch17-oop/listing-17-18/src/lib.rs:68:70}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-18/src/lib.rs:79:82}}
```
...
```rust,ignore
{{#include ../examples/ch17-oop/listing-17-11/src/main.rs:3:7}}
{{#include ../examples/ch17-oop/listing-17-11/src/main.rs:14}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-19/src/lib.rs}}
```
...
```rust
{{#include ../examples/ch17-oop/listing-17-20/src/lib.rs:21}}
    // --snip--
{{#include ../examples/ch17-oop/listing-17-20/src/lib.rs:26:43}}
```
...
```rust,ignore
{{#include ../examples/ch17-oop/listing-17-21/src/main.rs}}
```
