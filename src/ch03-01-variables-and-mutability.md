...
{{#include ../examples/ch03-common-programming-concepts/no-listing-01-variables-are-immutable/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-02-adding-mut/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-03-shadowing/src/main.rs}}
```
...
```rust
{{#include ../examples/ch03-common-programming-concepts/no-listing-04-shadowing-can-change-types/src/main.rs:3:4}}
```
...
```rust,ignore,does_not_compile
{{#include ../examples/ch03-common-programming-concepts/no-listing-05-mut-cant-change-types/src/main.rs:3:4}}
```
