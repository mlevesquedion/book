...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/listing-06-06/src/main.rs:2:6}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-12-if-let/src/main.rs:2:5}}
```
...
```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-13-count-and-announce-match/src/main.rs:17:21}}
```

Or we could use an `if let` and `else` expression like this:

```rust
{{#include ../examples/ch06-enums-and-pattern-matching/no-listing-14-count-and-announce-if-let-else/src/main.rs:17:22}}
```
